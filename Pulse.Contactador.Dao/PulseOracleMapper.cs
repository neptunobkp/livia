...
{
    public sealed class PulseOracleMapper
    {
        ...
        private static void InitMapper()
        {
            try
            {
                ...
                XmlDocument sqlMapConfig = Resources.GetEmbeddedResourceAsXmlDocument("Config.sqlMapOracle.config, Pulse.Contactador.Dao");
