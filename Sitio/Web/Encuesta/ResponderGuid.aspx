<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResponderGuid.aspx.cs" MasterPageFile="~/Compartida/Masters/ExternoMaster.master"
    Inherits="Web_Encuesta_ResponderGuid" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content_body" runat="Server">
    ...
    <asp:HiddenField ID="hiddenLlaveEncuesta" runat="server" />
    <asp:HyperLink ID="hyperlinkBanner" runat="server">
        <asp:Image ID="imageBanner" ImageUrl="~/App_Themes/PulseTheme/css/styles/" runat="server" />
    </asp:HyperLink>
    <asp:ValidationSummary ID="vsEncuestas" runat="server" DisplayMode="BulletList" ShowMessageBox="true"
        ValidationGroup="vgEncuenstas" ShowSummary="false" HeaderText="Faltan completar las siguientes preguntas:" />
    <div id="formencuesta">
        <div class="content">
            <h1>
                <asp:Literal ID="literalTituloEncuesta" runat="server"></asp:Literal>
            </h1>
            <div id="descripcion-encuesta" style="font-size: 20px">
            ...
            <br />
            <asp:Button ID="btnEnviar" runat="server" OnClick="btnEnviar_Click" CausesValidation="true"
                ValidationGroup="vgEncuenstas" Text="Terminar Encuesta" />
            <br />
            <br />
