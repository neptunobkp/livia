<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PreguntaParrafo.ascx.cs" Inherits="Encuestas_PanelControl_PreguntaParrafo" %>
...
<table>
    <tbody>
        ...
        <tr>
            <td class="center">
                <asp:TextBox ID="tbTextoParaUsuario" runat="server" Text="El usuario escribira aqui" TextMode="MultiLine" Height="100px" Width="400px" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="center">
