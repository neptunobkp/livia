...
public partial class Encuestas_Resultado_ResultadoPreguntaParrafo : System.Web.UI.UserControl
{
    ...
    public void EstablecerRespuesta(ItemRespuesta item)
    {
        if (item != null)
            this.tbTextoSimple.Text = item.GlosaRespuesta;
    }
}
