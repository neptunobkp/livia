...
public partial class Encuestas_Resultado_ResultadoPreguntaOpcionMultiple : System.Web.UI.UserControl
{
    ...
    public void EstablecerRespuesta(List<ItemRespuesta> itemsRespuesta)
    {
        foreach (var cadaItemRespuesta in itemsRespuesta)
        {
            ListItem listItem = this.checkboxListOpciones.Items.FindByValue(cadaItemRespuesta.ValorRespuesta);
