...
public partial class Encuestas_Resultado_ResultadoPreguntaSimple : System.Web.UI.UserControl
{
    ...
    {
        if (itemRespuesta == null) return;
        this.tbTextoSimple.Text = itemRespuesta.GlosaRespuesta;
    }
}
