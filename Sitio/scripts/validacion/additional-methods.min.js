...
jQuery.validator.addMethod("rut", function(value, element) { return this.optional(element) || $.Rut.validar(value); }, jQuery.validator.messages.rut);
jQuery.validator.addMethod("primeraletra", function(value, element) { return this.optional(element) || /^[a-z]+$/i.test(value.charAt(0)) }, jQuery.validator.messages.primeraletra);
jQuery.validator.addMethod("enteros", function(value, element) { return this.optional(element) || /^-?\d+$/.test(value); }, jQuery.validator.messages.numero);
...
jQuery.validator.addMethod("algunorequerido", function(value, element, param) {
    var val = $(element).val();
    var valalter = $(param).val();
    return (val && val.length > 0) || (valalter && valalter.length > 0);
}, "Porfavor complete alguno de los campos.");
